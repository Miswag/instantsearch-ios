...
public class MyDynamicFacetListConnector<Searcher: SearchResultObservable> where Searcher.SearchResult == MultiSearchResponse {
	...
	public init(searcher: Searcher,
				...
				interactor: MyDynamicFacetListInteractor,
...
extension MyDynamicFacetListConnector: Connection {
